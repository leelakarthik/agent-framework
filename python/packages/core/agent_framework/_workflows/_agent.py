...
class WorkflowAgent(BaseAgent):
    ...
    def _filter_messages(self, chat_messages: list[Message]) -> Message | None:
        ...
        return next((m for m in reversed(chat_messages) if m.role != "user"), None)
        ...
        for output_event in output_events:
            if output_event.type == "request_info":
                ...
                if isinstance(data, AgentResponse):
                    ...
                    chat_messages = self.__filter_messages(cast(list[Message], data))
